...
- Two concentric progress rings around the dial: an inner **week** ring (curved weekday labels, starting Sunday) and an outer **month** ring (curved day-of-month numbers, spaced by the actual number of days in the current month). The week fill covers through today and creeps toward the next weekday across the day (in two-hour steps), so just before midnight it barely touches tomorrow's label. The month ring fills from the start of the month up to today's date.
